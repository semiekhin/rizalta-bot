"""MGP calculator — Минимальный Гарантированный Платёж.
Ported from /opt/bot-dev/services/mgp_calculator.py."""
...
# === МГП Константы ===
MGP_TOTAL_AREA = 42_717.4  # Общий номерной фонд, м²
...
MGP_YEARLY_AMOUNTS = [
    ...
    1_200_000_000,    # 8 год
    1_250_000_000,    # 9 год
    1_300_000_000,    # 10 год
    1_300_000_000,    # 11 год
    1_300_000_000,    # 12 год
    1_300_000_000,    # 13 год
    1_300_000_000,    # 14 год
    1_300_000_000,    # 15 год
]
...
def calc_mgp(area: float) -> list:
    """Calculates MGP nominal + commercial. Returns list of (year, mgp_nom, mgp_comm)."""
    result = []
    for i in range(15):
...
def generate_mgp_pdf(code: str, area: float, building: int = None) -> str:
    """Generates PDF with MGP table. Returns path to temp file."""
    rows = calc_mgp(area)
