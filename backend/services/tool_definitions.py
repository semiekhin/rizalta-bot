...
TOOLS = [
    {
        ...
        "name": "search_lots",
        "description": (
            "Поиск лотов в RIZALTA Resort Belokurikha. "
    ...
    },
    {
        ...
        "description": (
            "Получить полную информацию о лоте по коду. "
    ...
    },
    {
        ...
        "name": "calculate_roi",
        "description": (
            "Рассчитать инвестиционную доходность (ROI) лота RIZALTA. "
    ...
    },
    {
        ...
        "description": (
            "Рассчитать варианты рассрочки для лота RIZALTA. "
        ...
        "parameters": {
            ...
            "properties": {
                "price": {
                    "type": "integer",
                    "description": "Стоимость лота в рублях"
                }
            },
            "required": ["price"]
        }
