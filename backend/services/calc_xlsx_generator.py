...
import os
"""
Генератор Excel-файла с расчётом прибыли от лота RIZALTA
...
class ProfitCalculatorGenerator:
    ...
    def _create_params_section(self, ws):
        ...
        headers = {
            ...
            'D': 'Стоимость, руб',
            'F': 'Расходы, %',
            'G': 'Прибыль от роста стоимости кв.м. лота в год, %',
            'H': 'Срок окупаемости лота, лет',
            'I': 'Срок окупаемости лота (от сдачи), лет'
        }
    ...
    def _create_table_header(self, ws):
        ...
        headers = {
            ...
            'F': 'Расходы, руб',
            'G': 'Прибыль от сдачи лота, руб',
            'H': 'Накопительная прибыль от сдачи лота, руб',
            'I': 'Прибыль от роста стоимости кв.м. лота, руб',
            'J': 'Прибыль накопительно',
            'L': 'Прибыль от сдачи лота в год, %',
            'M': 'Прибыль роста цены от стоимости лота в год, %',
            'N': 'Общая прибыль от стоимости лота в год, %'
        }
