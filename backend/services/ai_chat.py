...
## ЖЁСТКИЕ ОГРАНИЧЕНИЯ БЮДЖЕТА:
- Сценарий 1: цена лота × 0.95 ≤ {budget} ₽
- Сценарий 2: СУММА (цена × 0.95 по КАЖДОМУ лоту) ≤ {budget} ₽. Посчитай сумму ПЕРЕД выбором!
- Сценарий 3: СУММА (цена × 0.30 по КАЖДОМУ лоту) ≤ {budget} ₽. Посчитай сумму ПЕРЕД выбором!
Если не уверен — лучше взять меньше лотов.
