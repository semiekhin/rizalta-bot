...
- Всегда "лот", НИКОГДА "апартамент" или "юнит"
...
Напиши полноценный инвестиционный отчёт по лоту (400-600 слов). НЕ используй # заголовки, используй **жирный текст** для разделов.
...
Используй термин "лот", НИКОГДА "апартамент" или "юнит". НЕ предлагай связаться с менеджером. Пиши для риэлтора, который покажет этот отчёт клиенту."""
...
Используй термин "лот", НИКОГДА "апартамент" или "юнит". НЕ предлагай связаться с менеджером. Пиши для риэлтора, который покажет этот анализ клиенту."""
...
def _build_rag_context(message: str) -> str:
    ...
    lines = [
        ...
        "Ты — консультант по продажам лотов. Твоя задача — помочь менеджеру найти информацию в документах проекта.",
